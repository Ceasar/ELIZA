...
(ARE (
    ...
    (DO YOU SOMETIMES THINK I AM 4) (=WHAT))
    ((0 ARE 0)
...
(YOU = I
    ...
    ((0 I ARE 0)
        ...
        (PERHAPS YOU WOULD LIVE TO BE 4))
    ((0 I 0 YOU)
...
(CAN (
    (0 CAN I 0)
    (YOU BELIEVE I CAN 4 DON'T YOU) (=WHAT)
...
(WHAT (
    ...
    (WHY DO YOU THINK)
    (WHAT COMES TO YOUR MIND WHEN I ASK YOU THAT)
...
(BECAUSE (
    ...
    (DON'T ANY ONE REASONS COME TO MIND)
...
(EVERYONE 2 (
    ...
    (WHO, FOR EXAMPLE)
    (YOU ARE THINK OF A VERY SPECIAL PERSON)
    (WHO, MAY I ASK)
    (SOMEONE SPECIAL SPECIAL PERHAPS)
